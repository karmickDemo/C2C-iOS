...
class AppDelegate: UIResponder, UIApplicationDelegate,UNUserNotificationCenterDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        TWTRTwitter.sharedInstance().start(withConsumerKey:"ST3EseQw6MQEOaQQ77apErdsU", consumerSecret:"W7I7EklkboWIxDQtPyv279vzeYabuyEL9Cgu5xXl4I8L9729Ne")
        ...
        if signedInStatus == "signedIn" {
            ...
            let vc = instantiateViewController(storyboardID: "LoginViewController") as! LoginViewController
            let navController = UINavigationController.init(rootViewController: vc)
            navController.navigationBar.isHidden = true
            self.window?.rootViewController = navController
        }
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "C2C")
